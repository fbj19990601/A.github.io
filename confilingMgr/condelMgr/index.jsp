			...
			<tr>
				<td>
					<table width=100% border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#e7e7e7">
						<tr>
							<td class="line1" style="background-color: #e2e2e2; color: #000000; font-weight: bold; font-size: 13px;" align=center width="33%">
								<bean:message key="str1578"/>
							</td>
							<td style="background-color: #e2e2e2; color: #000000; font-weight: bold; font-size: 13px;" align=center width="20%">
								<bean:message key="str1605"/>
							</td>
						</tr>
						<%
						...
						<tr style="background-color: #f9f9f9;" id="changcolor_tr<%=i%>" onmouseover="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#ffffff','DIV')" onmouseout="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#f9f9f9','DIV')">
							...
							<td style="color: #000000; padding: 2px 5px;" align="center">
								<a href="addCondel.jsp?obj_cust_id=<%=obj_cust_id%>"><img src="/img/edit.png" style="cursor: hand;" border="0"> </a>
							</td>
						</tr>
						<%
						}
