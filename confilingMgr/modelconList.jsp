					...
					<table width=100% border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
						<tr>
							...
							<td style="background-color: #e2e2e2; color: #000000; font-weight: bold; font-size: 13px;" align=center width="10%">
								<bean:message key="str1599"/>
							</td>
							<td style="background-color: #e2e2e2; color: #000000; font-weight: bold; font-size: 13px;" align=center width="10%">
								<bean:message key="str1600"/>
							</td>
							<td style="background-color: #e2e2e2; color: #000000; font-weight: bold; font-size: 13px;" align=center width="10%">
						...
						<tr style="background-color: #f9f9f9;">
							...
							<td style="color: #000000;" align="center">
								<a href="modify.jsp?menu_id=<%=meun_idx%>&con_id=<%=con_id%>" TARGET=appwin onclick="mydefss()"><img src=/img/views.png width=16 height=16 border=0 style="cursor: hand" alt="查看详细资料"> </a>
							</td>
							<td style="color: #000000;" align="center">
								<a href="/doTradeReg.do?trade_type_code=1263&con_id=<%=con_id%>" target="_self" onclick="return delet();"><img src=/img/delete.png width=16 height=16 border=0 style="cursor: hand" alt="删除"> </a>
							</td>
						</tr>
						<%
							}
						...
						<tr>
							...
							<td align="right" colspan="3">
								<a href="modelconInfo.jsp?iStart=0"><bean:message key="str613"/> </a>&nbsp; &nbsp;
								<%
								if (Integer.parseInt(iStart) > 0) {
								%>
								<a href="modelconInfo.jsp?iStart=<%=pageUp%>"><bean:message key="str614"/></a> &nbsp;
								<%
									}
									if (Integer.parseInt(iStart) < pages - 1) {
								%>
								<a href="modelconInfo.jsp?iStart=<%=pageDown%>"><bean:message key="str615"/> </a>&nbsp;
								<%
								}
								%>
								<a href="modelconInfo.jsp?iStart=<%=pages - 1%>"><bean:message key="str616"/></a>
							</td>
						</tr>
					</table>
				</td>
