...
<body onload = "checkR(<%=infotype%>)">
	...
	<table width=980 border=0 cellpadding=2 cellspacing=1 align=center  bgcolor="#e7e7e7">
		<tr>
			<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="25%" colspan="1">±ÍÃ‚</td>
			<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="75%" colspan="2">ºÚΩÈ</td>			
		</tr>
	  <%
