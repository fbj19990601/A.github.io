	    ...
	    <td>
		     <table width=100% border=0 cellpadding=2 cellspacing=1 align=center  bgcolor="#e7e7e7">
		        <tr>
					...
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="8%"><bean:message key="str1650"/></td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="19%"><bean:message key="str1255"/></td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="18%"><bean:message key="str1256"/></td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="40%" ><bean:message key="str1332"/></td>
		        </tr>
		        <%
		            ...
		            {    int i=0;
		              	 for (Iterator it = relationList.iterator(); it.hasNext();)
		                  {
						        ...
						        <tr style="background-color:#f9f9f9; " id="changcolor_tr<%=i%>" onmouseover="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#ffffff','DIV')" onmouseout="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#f9f9f9','DIV')">
					              <td align="left"  style=" color:#3300FF; padding:2px 5px;" ><a href="modifyUserInfo.jsp?cust_id=<%=cust_id%>&user_id=<%=user%>&view=view" target=blank><%=cust_name%></a></td>
					              <td  style=" color:#000000;" align=center><%=sex%></td>
					              <td align="left"  style=" color:#000000; padding:2px 5px;"><%=contact_phone%></td>
					              <td  style=" color:#000000; padding:2px 5px;"><%=email%></td>
