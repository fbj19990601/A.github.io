...
<%
	...
	ArrayList list=comm.getCustomerDefinitionById(id);
	String remark="",subsys_code="";
	if(list !=null && list.size()>0){
	  HashMap map=(HashMap)list.get(0);
	  if(map.get("remark")!=null){remark=map.get("remark").toString();}
	  if(map.get("subsys_code")!=null){
	    subsys_code=map.get("subsys_code").toString();
	    auditSel=bean.getItemsBySelected("80",subsys_code);
	  }
	...
	<body>
		<form name=resumeForm action=/doTradeReg.do method=post target="_self">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
																...
																<td style="background-color:#ffffff; color:#000000;  font-size:12px;" align=left width="35%">
																	<div class="ping">
																		<select name="leve_sel" id="leve_sel" onclick="checkLevel(this.value)">
																		 ...
																		 <option value="4"><bean:message key="str1933"/></option>
																...
																<td style="background-color:#ffffff; color:#000000;  font-size:12px;" align=left width="35%">
																	...
																	<select name="role_sel" id="role_sel" onclick="checkRole(this.value)">
																		 <option value="0"><bean:message key="str1019"/></option>
																		  <option value="1"><bean:message key="str1936"/></option>
				...
				<input type="hidden" name="trade_type_code" value="1171">
				<tr>
					<td align="center">
