...
<html>
	...
	<head>
		<title><bean:message key="str4657"/></title>
				...
				<tr>
					<td valign="top">
						<table width=100% border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
							<tr>
								<td style="background-color: #f6f6f6; color: #000000; font-weight: bold; font-size: 12px;width:15%" align=right>
							...
							<tr>
								<td style="background-color: #f6f6f6; color: #000000; font-weight: bold; font-size: 12px; display: none;" align=right width=15%>
									<bean:message key="str4652"/>
								</td>
								<td width=85% align=left bgcolor="#FFFFFF" style="display: none;">
									<div class="ping">
							...
							<tr>
								<td style="background-color: #f6f6f6; color: #000000; font-weight: bold; font-size: 12px; display: none;" align=right>
							...
							<tr>
								<td style="background-color: #f6f6f6; color: #000000; font-weight: bold; font-size: 12px; text-align: right; display: none;">
							...
							<input name="trade_type_code" type="hidden" value="1100" />
							<tr>
								<td style="background-color: #ffffff; color: #000000; font-size: 12px; padding: 3px 5px;" colspan=2 align="center">
									<input name="comit" type="button" value="" onclick="return Check_Value()" style="background-image: url('/images/tj.gif'); width: 70px; height: 26px; border: 0; cursor: hand; text-align: center;">
								</td>
							</tr>
