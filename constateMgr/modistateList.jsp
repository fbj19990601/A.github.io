...
<%
	...
	ArrayList autoList = conInfo.getConStateList1(Integer.parseInt(iStart), cust_id, "6");
	int counter = conInfo.getConStateList1(cust_id, "6");
					...
					<table width=100% border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
						...
						<tr style="background-color: #f9f9f9;">
							...
							<td style="color: #000000;" align="center">
								<a href="modiConstate.jsp?menu_id=<%=meun_idx%>&con_id=<%=con_id%>" TARGET=appwin onclick="mydefss()"><img src=/img/edit.png width=16 height=16 border=0 style="cursor: hand" alt="修改"> </a>
							</td>
						</tr>
						<%
							}
						...
						<tr>
							...
							<td align="right" colspan="3">
								...
								%>
								<a href="index.jsp?iStart=<%=pages - 1%>"><bean:message key="str1033"/></a>
							</td>
						</tr>
					</table>
				</td>
