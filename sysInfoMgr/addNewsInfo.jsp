...
<html>
	<head>
		<title>agricultural enterprise information service platform </title>
    ...
    function Check_Value()
	{
		...
		{
			alert("Please choose the information type ！");
		...
		{
			alert("Please enter the title of information！");
		  ...
		  var str=content.getText();
			...
			if(str == ""  )
			{
				alert("Please enter the content of infomation！");
				return false;
			}
			if( str.length > 4000)
			{
				 alert( "The  description of certificate should be less than that  4000" );
				 return false;	
			}
		  //////////////////判断时间是否合理////////////////
