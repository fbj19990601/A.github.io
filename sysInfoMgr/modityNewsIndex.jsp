...
<%
	...
	String str1 = "";
	ArrayList classlist = bean.getClassByUpIds();
	...
	String pageTools = tools.getPageTools(String.valueOf(counter),"20", "modityNewsIndex.jsp?iStart=", Integer.parseInt(iStart));
				...
				<td>
					<table width="100%" border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#e7e7e7">
						...
						<tr style="background-color: #f9f9f9;">
							...
							<td style="color: #000000;" align=center>
								<a href="/doTradeReg.do?news_id=<%=news_id%>&trade_type_code=0291" target="_self"><img src=/img/del.gif width=16 height=16 border=0 alt="delete information">
								</a>
							</td>
						</tr>
						<%
