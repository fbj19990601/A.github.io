...
<%
	...
	String pageTools = tools.getPageTools(String.valueOf(counter),"20", "modifyNewsIndex.jsp?iStart=", Integer.parseInt(iStart));
					...
					<table width="100%" border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#e7e7e7">
						...
						<tr style="background-color: #f9f9f9;">
							...
							<td style="color: #000000;" align=center>
								<a href=modifyNewsInfo.jsp?news_id= <%=news_id%> TARGET=appwin onclick="mydefss()"><img src=/img/edit.gif width=16 height=16 border=0 alt="Update information">
								</a>
							</td>
							<td style="color: #000000;" align=center>
								<a href="/doTradeReg.do?news_id=<%=news_id%>&trade_type_code=0291" target="_self"><img src=/img/del.gif width=16 height=16 border=0 alt="Delete informations">
								</a>
							</td>
						</tr>
						<%
