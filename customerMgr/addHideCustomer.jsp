...
<%
	...
	//客户级别
     ...
     String factory="",xcontury="",xcity="",xnumber="",xborn="",xmodel="",xbrief="";
 	 		String xaddress="",xpost="",xman="",xtel="",xfax="",xphone="",website="",email="";
    
     if(request.getParameter("factory")!=null)
     {
     	factory=new String(request.getParameter("factory").getBytes("ISO-8859-1"),"GBK");     	
     }        
     if(request.getParameter("xcontury")!=null)
     {
     	xcontury=new String(request.getParameter("xcontury").getBytes("ISO-8859-1"),"GBK");     	
     }
     if(request.getParameter("xcity")!=null)
     {
     xcity=new String(request.getParameter("xcity").getBytes("ISO-8859-1"),"GBK");    
     }
     if(request.getParameter("xnumber")!=null)
     {
     xnumber=new String(request.getParameter("xnumber").getBytes("ISO-8859-1"),"GBK");   
     }
     if(request.getParameter("xborn")!=null)
     {
     xborn=new String(request.getParameter("xborn").getBytes("ISO-8859-1"),"GBK");
     }
     if(request.getParameter("xmodel")!=null)
     {
     xmodel=new String(request.getParameter("xmodel").getBytes("ISO-8859-1"),"GBK");
     }
     if(request.getParameter("xbrief")!=null)
     {
     xbrief=new String(request.getParameter("xbrief").getBytes("ISO-8859-1"),"GBK");
     }
     if(request.getParameter("xaddress")!=null)
     {
     xaddress=new String(request.getParameter("xaddress").getBytes("ISO-8859-1"),"GBK");
     }
     if(request.getParameter("xpost")!=null)
     {
     xpost=request.getParameter("xpost");
     }
     if(request.getParameter("xman")!=null)
     {
     xman=new String(request.getParameter("xman").getBytes("ISO-8859-1"),"GBK");
     }
     if(request.getParameter("xtel")!=null){xtel=request.getParameter("xtel");}
     if(request.getParameter("xfax")!=null){xfax=request.getParameter("xfax");}
     if(request.getParameter("xphone")!=null){xphone=request.getParameter("xphone");}
     if(request.getParameter("website")!=null){website=request.getParameter("website");}
     if(request.getParameter("email")!=null){email=new String(request.getParameter("email").getBytes("ISO-8859-1"),"GBK");}
...
<html>
	...
	<body>
		<div id="login-body">
			<div id="lg_content">
				<form name="NewRegisterForm" id="NewRegisterForm" action="/doCustWebTradeReg.do" >
         ...
         <table width="100%" border="0" cellspacing="1" cellpadding="0">
          ...
          <tr>
            <td align="right" bgcolor="#f5f5f5" style="font-weight:bolder;"><bean:message key="str1076"/></td>
            <td colspan="3" align="left" bgcolor="#FFFFFF">
				<div class="ping" style="display:inline;"><input type="text" name="cust_name" value="<%=factory %>" maxlength="40" size="40" onfocus="CustName_focus(true, 1);" onblur="CustName_focus(false, 1);" class="login_textarea"></div>
          ...
          <tr>
            <td align="right" bgcolor="#f5f5f5" style="font-weight:bolder;"><bean:message key="str1862"/></td>
			...
			<input type="hidden" name="entity_type" id="entity_type" value="8">
										<bean:message key="str1863"/>	
          ...
          <tr>
            <td width="20%" align="right" bgcolor="#f5f5f5" style="font-weight:bolder;"><bean:message key="str1864"/></td>
            <td width="80%" align="left" bgcolor="#FFFFFF" colspan="3"><div class="ping"><input type="text" value="<%=email %>" name="email" maxlength="20" class="login_textarea" onblur="checkEmail()"></div>
            ...
            <tr>
              <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top" style="border-left:2px solid #FF6600;border-top:2px solid #fff; border-bottom:1px solid #fff; padding-left:10px; font-weight:bolder; font-size:14px; color:#000000; background-color:#e0e0e0; line-height:30px; "><bean:message key="str1865"/></td>
                  </tr>
                  <tr>
          ...
          <tr>
			  ...
			  <font style="display:none"><bean:message key="str1049"/></font>
			  <div class="ping1" style="display:inline;">
          ...
          <tr>
            ...
            <td width="30%" align="left" bgcolor="#FFFFFF"><div class="ping1"><input name="cust_aim" value="<%=factory %>" type="text" maxlength="40" size="30" class="login_textarea"></div></td>
            <td width="20%" align="right" bgcolor="#f5f5f5" style="font-weight:bolder;"><bean:message key="str1698"/></td>
            <td width="30%" align="left" bgcolor="#FFFFFF"><div class="ping1"><input name="company_address" type="text" maxlength="50" value="<%=xaddress %>"
											size="40" class="login_textarea"></div></td>
          </tr>
          <tr>
            <td align="right" bgcolor="#f5f5f5" style="font-weight:bolder;"><bean:message key="str1088"/></td>
            <td align="left" bgcolor="#FFFFFF"><div class="ping1"><input name="website" type="text" size="25" maxlength="50" value="<%=website %>"
          ...
          <tr>
            ...
            <td align="left" bgcolor="#FFFFFF"><div class="ping1"><input name="group_contact_phone" type="text" size="25" value="<%=xtel %>"
            ...
            <td align="left" bgcolor="#FFFFFF"><div class="ping1"> <input name="fax_nbr" type="text" size="15" maxlength="15" value="<%=xfax %>"
											class="login_textarea"></div></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="3" align="left" bgcolor="#FFFFFF"><div class="ping1"><textarea name="scope" cols="50" rows="6"><%=xbrief %></textarea></div></td>
            </tr>
        </table></td>
                  </tr>
              </table></td>
            ...
            <tr>
              <td height="40" align="center"><div id="lg_title1">
							...
							<input type="image" name="imageField2" src="/images/tj.gif" onclick="return submitInfo();">
							<input type="hidden" name="trade_type_code" value="5591">
