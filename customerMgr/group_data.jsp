...
<html>
	...
	<body>
	<%
      String cust_id="",class_id="",group_type="";
      if(request.getParameter("cust_id") != null) {
	   ...
	   int size=0,join=0;
	   String table = "<table width=100% border=0 cellspacing=1 cellpadding=0><tr style=text-align:left; font-weight:bold;margin-left: 5px;bgcolor=#B4B4B4><td bgcolor=#B4B4B4 colspan=3 width='90%' color=#FFFFFF><img src=/img/delUser.png border=0>以下是你所选分类下已存在的客户,如果要进行删除操作，请选中要删除的记录后，点击删除按钮！</td><td align=right bgcolor=#B4B4B4 width='10%'><input type=button name=dbtn value=删除 onclick=delCustomer()></td></tr>";
	   ...
	   String tablej = "<tr style=text-align:left; font-weight:bold;margin-left: 5px;bgcolor=#B4B4B4><td bgcolor=#B4B4B4 colspan=3 width='90%' color=#FFFFFF><img src=/img/addUser.png border=0>你可以将以下客户添加到你所选的分类里,如果要进行操作，请选中的客户记录后，点击添加按钮！</td><td align=right  bgcolor=#B4B4B4 width='10%'><input type=button name=abtn value=添加 onclick=addCustomer()></td></tr>"+
	   ...
	   if(joinList !=null && joinList.size()>0){
	     ...
	     for (int i = 0; i < joinList.size(); i++) {
			...
			if (map.get("group_contact_phone") != null) {
			 ...
			 tablej=tablej+"<tr><td align=center ><input type=checkbox value="+obj_cust_id+" name=ckbxj"+j+"  id=ckbxj"+j+"</td><td align=left>"+cust_name+"</td><td align=left>"+phone+"</td><td align=left>"+email+"</td></tr>";
		    }else{
			 tablej=tablej+"<tr><td align=center bgcolor=#efefef><input type=checkbox value="+obj_cust_id+" name=ckbxj"+j+"  id=ckbxj"+j+"</td><td align=left bgcolor=#efedef>"+cust_name+"</td><td align=left bgcolor=#efefef>"+phone+"</td><td align=left bgcolor=#efedef>"+email+"</td></tr>";
		    }
		    j++;
		}
	   }
	   table=table+tablej+"</table><input type=hidden id=count name=count value="+size+"><input type=hidden id=join name=count value="+(j++)+">";
	   out.print(table);
     %>
	</body>
</html>
