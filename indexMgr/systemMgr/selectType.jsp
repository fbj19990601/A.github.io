...
<table width="100%" border="0" cellpadding="10" cellspacing="1" align="center" bordercolor="#D1D1D1" >
  <tr>    
    ...
    <td class="grayD" align="center" width="30%"><bean:message key="str4259"/></td>
    <td class="grayD" align="center" width="8%"><bean:message key="str1295"/></td>
  </tr>
<%
...
<tr> 
	    <td colspan=7> 
		    ...
		    <tr> 
				...
				<html:link href="selectType.jsp" name="indexmap"><bean:message key="str1030"/> </html:link>
			    <%
				...
				<html:link href="selectType.jsp" name="upmap"><bean:message key="str1031"/></html:link>
			    <%
				...
				<html:link href="selectType.jsp" name="downmap"><bean:message key="str1032"/> </html:link>
			    <%
				    HashMap endmap=new HashMap();   						
				  	endmap.put("Begin",endBegin);
				  	pageContext.setAttribute("endmap",endmap);
			  	%>			  		  					
				<html:link href="selectType.jsp" name="endmap"><bean:message key="str2545"/> </html:link>
			    </div>
			    </td>
		    </tr>
		    </table>
