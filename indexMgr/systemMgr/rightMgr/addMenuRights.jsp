...
<table width="100%" border="0" cellpadding="10" cellspacing="1" align="center" bordercolor="#D1D1D1" >
  <tr>    
    ...
    <td class="grayD" align="center" width="30%"><bean:message key="str3939"/></td>
    <td class="grayD" align="center" width="20%"><bean:message key="str3940"/></td>
  </tr>
<%
	...
	if(ClassList!=null && ClassList.size()>0)
	{
		for (Iterator its = ClassList.iterator(); its.hasNext();) 
			...
			<td class="grayBL" align="left"><%=xuhao%></td>
	      	<td class="grayBL" align="left">〖<%=class_code%><bean:message key="str3996">〗"/>
	     	<%=class_name%></td>
