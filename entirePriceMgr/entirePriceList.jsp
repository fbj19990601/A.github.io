...
<%
   HttpSession  logsession = request.getSession(); 
    ...
    // out.print( user_id );
	  ...
	  ArrayList trackList = enquirytrack.getStockListByUser( Integer.valueOf(iStart).intValue(), user_id );
	  //out.print( trackList );
	  ArrayList List = new ArrayList();
	  ParamethodMgr paramObj = new ParamethodMgr();
	  
	  int counter = enquirytrack.getStockNumberByUser( user_id );
		        ...
		        <%
		            ...
		            {    
			          	...
			          	for (Iterator it = trackList.iterator(); it.hasNext();)
			            {
					        ...
					        String stack_id = map.get( "stack_id" ).toString();
					        String user_name="";
					        user_id = "";
				        ...
				        <%i++;
					     ...
					     %>
									<tr>					  
										...
										<a href="entirePriceList.jsp?iStart=0"><bean:message key="str1030"/>  </a>&nbsp; &nbsp;
										<% 
											if(Integer.parseInt(iStart)>0){
										%>
											<a href="entirePriceList.jsp?iStart=<%=pageUp%>"><bean:message key="str1031"/></a> &nbsp;
										<%
											}
											if(Integer.parseInt(iStart)<pages-1){
										%>
											<a href="entirePriceList.jsp?iStart=<%=pageDown%>"><bean:message key="str1032"/>  </a>&nbsp; 
										<%
											}
										%>
										<a  href="entirePriceList.jsp?iStart=<%=pages-1%>"><bean:message key="str1033"/></a></td>
							    </tr>
					     <%
		            }
		        %>
