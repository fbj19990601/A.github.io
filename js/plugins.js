...
Plugin.oa_file_Window = Ext.extend(Ext.app.Module, {
    init : function(){
        this.launcher = {
            text: '发送意见给运营商',
            iconCls:'accordion',
            handler:function(){ window.location = "/main.jsp?menu_id=4KJD7F1YDKS776KP&menu_class=3&subsys_code=B2B"; },
            //handler : this.createWindow,
            scope: this
        }
    },
...
Plugin.oa_bbs_Window = Ext.extend(Ext.app.Module, {
    init : function(){
        this.launcher = {
            text: '我的知识库',
            iconCls:'accordion',
            handler:function(){ window.location = "/main.jsp?info_type=0&menu_id=771j2Kh4i3A17f3ut44t&menu_class=3&subsys_code=B2B"; },
            //handler : this.createWindow,
            scope: this
        }
    },
