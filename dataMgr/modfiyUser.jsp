...
%>
 <html>
	<head>
		<title><bean:message key="str1037"/></title>
					...
					<td background="/img/bg-2.gif">
						<table width=93% border=0 cellpadding=5 cellspacing=1
							...
							<tr>
								...
								<td style="background-color:#ffffff; color:#000000;  font-size:12px; padding:5px; display:inline" align=left>
								   <div id="sh" style="display: none;">
									...
									<input type="checkbox" id="org" name="org" onclick="shwoOrHidden()"><bean:message key="str1043"/>		
								</td>
							</tr>
							<tr style="display:none">
								<td align=right style="background-color:#f6f6f6; color:#000000;  font-weight:bold; font-size:12px;">
										<bean:message key="str1044"/>								</td>
								<td style="background-color:#ffffff; color:#000000;  font-size:12px; padding:5px;" align=left>
									<select name=web_login_tag>
										<option value=1>
											<bean:message key="str1045"/>
										</option>
										<option value=0>
											<bean:message key="str1046"/>
										</option>
									</select>
								</td>
							</tr>
							...
							<tr style="display:none">
								...
								<td style="background-color:#ffffff; color:#000000;  font-size:12px;padding:5px;" align=left>oornam
						   ...
						   <td bgcolor="#FFFFFF">
							...
							<tr>
								<td style="background-color:#ffffff; color:#000000;  font-size:12px; padding:5px;" align=center colspan=2>
									<INPUT id=advcheck name=advshow type=checkbox value=0 onclick=check_none(Userform)>
