...
<html>
	<head>
		<title><bean:message key="str1137"/></title>
										...
										<form name="departForm" id="departForm" action="/doTradeReg.do" method="post" target="_self">
												...
												<div class="bj1">
													<table width="100%" border="0" cellspacing="1" cellpadding="0">
														<tr>
															...
															<td width="86%" align="left" bgcolor="#FFFFFF">
																<div class="ping">
																  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                     <tr>
                                                                       <td><div id="tree-div" style="display:inline;float:left;"></div></td>
                                                                     </tr>
                                                                   </table>
															    </div>
														    </td>
														...
														<input name="remark" id="remark" type="hidden" value="经销商分类">
												  </table>
												</div>
										</form>
									</td>
