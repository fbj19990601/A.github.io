...
<%
	...
	String session_cust = (String) sesson
			.getAttribute("SESSION_CUST_ID");
	...
	//密码提示问题
	ArrayList passReqList = paramCom.getCompareInfo("CRM",
			"passwd_ques");
	//工作单位
	...
	ArrayList list = entityClass.getEntityByUpClassAndEntity(
			session_cust, "000000000000000", "4");
	String default_code = bean.GenTradeId();
	String develope_channel = new Custinfo()
			.getCustChannal(session_cust);
%>
<html>
	<head>
		<title><bean:message key="str1162"/></title>
...
.orange {
	...
	<body>
		<div id="login-body">
			<div id="lg_content">
				<form method="post" name="NewRegisterForm" id="NewRegisterForm" action=/doTradeReg.do target="_self">
											...
											<table width="100%" border="0" cellspacing="1" cellpadding="0">
												<tr style="display: none">
													<td width="17%" align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
														<bean:message key="str1164"/>
													</td>
													<td colspan="3" align="left" bgcolor="#FFFFFF">
														<div class="ping" style="display: inline;">
															<input name="user_name" type="text" value="<%=default_code%>">
														</div>
														<div class="ping1" style="display: inline">
														<bean:message key="str1165"/>
														</div>
													</td>
												</tr>
												<tr style="display: none">
													<td align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
														<bean:message key="str1167"/>
													</td>
													<td colspan="3" align="left" bgcolor="#FFFFFF">
														<div class="ping" style="display: inline;">
															<input type="text" name="passwd" value="123456" class="login_textarea">
														</div>
														<div class="ping1" style="display: inline">
														<bean:message key="str1679"/>
														</div>
													</td>
												</tr>
												<tr style="display: none">
												...
												<tr>
													<td align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
												<bean:message key="str1169"/>
													</td>
													<td colspan="3" align="left" bgcolor="#FFFFFF">
														<div class="ping" style="display: inline;">
															<input type="text" name="cust_name" maxlength="20" onfocus="CustName_focus(true, 1);" onblur="CustName_focus(false, 1);" class="login_textarea">
														</div>
														<div id="divCustName" class="ping1" style="display: inline">
														<bean:message key="str1170"/>
														</div>
													</td>
												</tr>
												<tr>
													<td align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
														<bean:message key="str1171"/>
													</td>
													<td colspan="3" align="left" bgcolor="#FFFFFF">
														<div class="ping" style="display: inline;">
															<select name="rela_class" id="rela_class" maxlength="50" class="login_textarea">
																<%
														...
														<div class="ping1" style="display: inline">
														<bean:message key="str1172"/>
															<a href="/levelMgr/levelIndex.jsp?menu_id=2EXFGfO71V2R8L6x8S&info_type=0" TARGET=appwin onclick="mydefss()"><span style="color: blue"><bean:message key="str1173"/></span>
															</a><bean:message key="str1174"/>
														</div>
													</td>
												</tr>
												<tr>
													<td align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
														<bean:message key="str1175"/>
													</td>
													<td colspan="3" align="left" bgcolor="#FFFFFF">
														<div class="ping">
															...
															<input type="hidden" name="entity_type" id="entity_type" value="4">
															...
															<div style="line-height: 80px; margin-left: 5px;">
																<a href="/entitypropMgr/classIndex.jsp?menu_id=2EpTKLTyXdV2R8LVx8S1&info_type=0" TARGET=appwin onclick="mydefss()"><span style="color: blue"><bean:message key="str4722"/></span>
																</a>
															</div>
														</div>
													</td>
												...
												<tr>
													<td width="20%" align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
														<bean:message key="str1176"/>
													</td>
													<td width="80%" align="left" bgcolor="#FFFFFF" colspan="3">
														<div class="ping">
											...
											<table width="100%" border="0" cellspacing="1" cellpadding="0">
												<tr>
													...
													<td width="30%" align="left" bgcolor="#FFFFFF">
														<div class="ping1">
															<select name="passwd_ques" maxlength="50" class="login_textarea">
																<%
													...
													<td width="20%" align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
													<bean:message key="str1178"/>
													</td>
													<td colspan="4" width="30%" align="left" bgcolor="#FFFFFF">
														<div class="ping1">
															<input type="text" name="passwd_answer" maxlength="50" class="login_textarea">
														</div>
													</td>
												</tr>
												<tr>
													<td align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
												<bean:message key="str1179"/>
													</td>
													<td colspan="6" align="left" bgcolor="#FFFFFF" colspan="5">
														<div class="ping1">
										...
										<td valign="top" bgcolor="#CCCCCC">
											<table width="100%" border="0" cellspacing="1" cellpadding="0">
												<tr>
													...
													<td width="30%" align="left" bgcolor="#FFFFFF">
														<div class="ping1">
															<input name="cust_aim" type="text" maxlength="40" size="30" class="login_textarea">
														</div>
													</td>
													<td width="20%" align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
														<bean:message key="str1698"/>
													</td>
													<td width="30%" align="left" bgcolor="#FFFFFF">
														<div class="ping1">
															<input name="company_address" type="text" maxlength="50" size="40" class="login_textarea">
														</div>
													</td>
												</tr>
												<tr>
													...
													<td align="left" bgcolor="#FFFFFF">
														<div class="ping1">
															<input name="website" type="text" size="25" maxlength="50" class="login_textarea">
														</div>
													</td>
													<td align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
														<bean:message key="str1183"/>
													</td>
													<td align="left" bgcolor="#FFFFFF">
														<div class="ping1">
															<select name="user_count" class="login_textarea">
																<option value="1">
																	10-50人  <bean:message key="str4723"/>
																</option>
																<option value="2">
																	50-100人  <bean:message key="str4723"/>
																</option>
																<option value="3">
																	100-300人 <bean:message key="str4723"/>
																</option>
																<option value="4">
																	300-1000人 <bean:message key="str4723"/>
																</option>
																<option value="5">
																	1000+人 <bean:message key="str4723"/>
																</option>
															</select>
														</div>
													</td>
												...
												<tr>
													...
													<td align="left" bgcolor="#FFFFFF">
														<div class="ping1">
															<input name="group_contact_phone" type="text" size="25" maxlength="50" class="login_textarea">
														</div>
													</td>
													<td align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
												...
												<tr>
													...
													<td align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
														<bean:message key="str1645"/>
													</td>
													<td align="left" bgcolor="#FFFFFF">
														<div class="ping1">
															<input type="text" name="juristic" maxlength="30" class="login_textarea">
														</div>
													</td>
												</tr>
												<tr>
													<td align="right" bgcolor="#f5f5f5" style="font-weight: bolder;">
														<bean:message key="str1646"/>
													</td>
													<td colspan="3" align="left" bgcolor="#FFFFFF">
														<div class="ping">
															<table>
																<tr>
																	...
																	<td>
																		<select name="sort1" size="10" onChange="this.form.sort2.options.length=0;this.form.sort3.options.length=0;getSubitems(this.form.sort2, this.value)">
																			<option selected value="0">
																				<bean:message key="str2655"/>
																			</option>
																		</select>
																	...
																	<td>
																		<select name="sort2" size="10" onChange="this.form.sort3.options.length=0;getSubitems(this.form.sort3, this.value)">
																			<option value="0">
																				<bean:message key="str2655"/>
																			</option>
																		</select>
						...
						<tr>
							<td height="40" align="center">
								<div id="lg_title1">
									...
									<input type="hidden" name="relation_type_code" value="4">
...
function submitInfo(){
	...
	if(document.NewRegisterForm.sev1.value=="" || document.NewRegisterForm.sev1.value==null){
	  alert("经销商分类不能为空！如果你没有分类，请点击『添加经销商分类』，增加分类！");
	 return false;
	}
  ...
  if(document.NewRegisterForm.email.value!="")//当E_mail中有值时判断E_mail格式是否正确
   {
	...
	if(document.NewRegisterForm.sort1.value == ""||document.NewRegisterForm.sort1.value == null)
	{
		alert("主营行业不能为空！");
		return false;
	}
