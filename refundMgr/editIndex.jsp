...
<%
	String menu_id = "",form_id="",quo_id="",sale_quo_id="";
...
<html>
	<head>
		<title><bean:message key="str3326"/></title>
							...
							<table width="740" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td>
										...
										<jsp:include flush="true" page="editRefundInfo.jsp">
										<jsp:param name="form_id" value="<%=form_id%>"/>
										<jsp:param name="quo_id" value="<%=quo_id%>"/>
										<jsp:param name="sale_quo_id" value="<%=sale_quo_id%>"/>
										</jsp:include>
									</td>
								</tr>
							</table>
