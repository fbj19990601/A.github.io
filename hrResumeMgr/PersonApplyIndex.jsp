			...
			<body>
	            ...
	            <tr>
	              ...
	              <td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center  width="10%"><bean:message key="str1769"/></td>
				        <td  style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="10%"><bean:message key="str1384"/></td>
	            </tr>
	            <%
	              if( jobList != null && jobList.size() > 0 )
	              {
	                 for (Iterator it = jobList.iterator(); it.hasNext();)
	                 {
								      HashMap map = (HashMap) it.next();
									    ...
									    String resume_id=map.get("resume_id").toString();
									    String title ="";
									    String req ="";
									    String job_addr="";
									    String publish_date="";
	            ...
	            <tr style="background-color:#f9f9f9; ">
	              ...
	              <td  style=" color:#000000;" align=center><a href=modifyjobInfo.jsp?job_id=<%=job_id%> TARGET="_self"><img src=/img/edit.gif width=16 height=16 border=0 alt="修改信息"></a></td>
	               <td  style=" color:#000000;" align=center><a href=JobapplicantsInfo.jsp?resume_id=<%=resume_id%> TARGET="_self"><img src=/img/edit.gif width=16 height=16 border=0 alt="应聘信息"></a></td>
