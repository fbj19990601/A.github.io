	  ...
	  <tr>
	    <td>
		     <table width="100%" border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#e7e7e7">
		        <tr>
					<td  class="line1" style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="10%"><bean:message key="str2007"/></td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="30%"><bean:message key="str2453"/></td>
					...
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="5%"><bean:message key="str156"/></td>
		        </tr>
		        <%
		            if(commList != null && commList.size()>0 )
		            {
		              	 for (Iterator it = commList.iterator(); it.hasNext();)
		                  {
						        ...
						        <tr  style="background-color:#f9f9f9; " id="changcolor_tr<%=commodity_id%>" onmouseover="MM_changeProp('changcolor_tr<%=commodity_id%>','','backgroundColor','#ffffff','DIV')" onmouseout="MM_changeProp('changcolor_tr<%=commodity_id%>','','backgroundColor','#f9f9f9','DIV')">
					              ...
					              <td  style=" color:#000000;" align=center><a href=modifyProductInfo.jsp?commodity_id=<%=commodity_id%>&trade_type_code=0276 target=blank ><img src=/img/edit.gif width=16 height=16 border=0></a></td>
					            </tr>
					     ...
					     <tr>
							...
							<td  align="left" colspan="4"><a href="modifyCommIndex.jsp?iStart=0&meun_id=<%=meun_idx%>"><bean:message key="str613"/> </a>&nbsp; &nbsp;<a href="modifyCommIndex.jsp?iStart=<%=pageUp%>&meun_id=<%=meun_idx%>"><bean:message key="str614"/></a> &nbsp;<a href="modifyCommIndex.jsp?iStart=<%=pageDown%>&meun_id=<%=meun_idx%>"><bean:message key="str615"/> </a>&nbsp; <a  href="modifyCommIndex.jsp?iStart=<%=pages%>&meun_id=<%=meun_idx%>"><bean:message key="str616"/></a></td>
				         </tr>
