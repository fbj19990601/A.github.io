...
<% 
	...
	ArrayList custList = action.getNewAction(cust_id,"0");
%>

<!--最新联系人动态-->
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="chag3">
  <tr>
    <td><table width="708" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" background="images/xi_06.gif"><table width="100%" border="0" cellspacing="0" cellpadding="3" >
            <tr>
              <td width="18%">&nbsp;<span class="biaoti"><bean:message key="str1365"/></span></td>
              <td width="66%" class="table_left_right_xian">&nbsp;<span class="biaoti"><bean:message key="str1374"/></span></td>
              ...
              <% 
			  	...
			  	if(custList!=null && custList.size()>0){
			  		for(int i = 0;i<custList.size();i++){
			  			...
			  			if(custMap.get("rsrv_str10")!=null){
			  				own_id=custMap.get("rsrv_str10").toString();
			  				cust_name = cust.getCustNameById(own_id);
			  			}
			  %>
                <tr>
                  <td width="18%"><a href="/customerMgr/Custinfo.jsp?obj_cust_id=<%=own_id %>" TARGET=appwin onclick="mydefss()"><%=own_id %></a></td>
