...
<% 
	...
	ArrayList custList = action.getNewAction(cust_id,"1");
%>

<!--最新客户动态-->
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="chag2">
  <tr>
    <td><table width="708" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" background="images/xi_06.gif"><table width="100%" border="0" cellspacing="0" cellpadding="3" >
            <tr>
              <td width="24%">&nbsp;<span class="biaoti"><bean:message key="str1834"/></span></td>
