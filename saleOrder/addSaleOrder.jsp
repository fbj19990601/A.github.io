...
<%
	...
	String give_date=formate.format(cal.getTime());
%>
<html>
	<head>
		...
		function addDetial(field_id,id){
		 if(document.getElementById(id).checked){
			 ...
			 window.open ("addOrderItme.jsp?form_id="+form_id+"&field_id="+field_id+"&quo_id="+id);
		 }
		}
	...
	<body>
		<form name=resumeForm action=/doTradeReg.do method=post target="_self">
			<table width="727" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px" bgcolor="#dddddd">
				<tr>
					<td height="2"></td>
				</tr>
				<tr>
					<td valign="top">
						<table width=727 border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#FFFFFF">
							...
							<tr>
								<td style="background-color:#f6f6f6; color:#000000;font-size:15px;text-align:left;">
									           ...
									           if(field_type=="0" || field_type.equals("0")){
									            ...
									            html="<input type=hidden name="+field_id+" id=id"+idx+" value=0>";
									             ...
									             field_type="<input type=text name=item_name size=30 maxlength=50 onblur=setHtmlCode(this.value,'id"+idx+"')>";
									              ...
									              field_type="<input type=checkbox name=bnt id="+detail_id+" value=明细录入 onclick=addDetial('"+field_id+"','"+detail_id+"')>明细录入| <a href=viewOrderItem.jsp?form_id="+form_id+"&quo_id="+detail_id+" target=_blank>查看明细</a>";
							...
							<input type="hidden" name="state_code" id="state_code" value="0">
							<tr height="25px">
								<td style="background-color:#f6f6f6; color:#000000;text-align:left;" width=100%>
									<bean:message key="str3408"/><input name="give_date" id="give_date" size="10" maxlength="15" value="<%=give_date%>"  onfocus="setday(this);" readonly>
								</td>
							</tr>
							<tr height="25px">
								<td style="background-color:#f6f6f6; color:#000000;text-align:left;" width=100%>
									<bean:message key="str164"/><input name="remark2" id="remark2" size="52" maxlength="50" value="">
								</td>
							</tr>
							<tr>
