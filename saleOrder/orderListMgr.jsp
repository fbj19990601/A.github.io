...
<html>
<head>
<title><bean:message key="str3413"/></title>
	  ...
	  <tr>
	    <td>
		     <table width=727 border=0 cellpadding=2 cellspacing=1 align=center  bgcolor="#e7e7e7">
		        <tr>
			        <td class="line1" style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="25%"><bean:message key="str3414"/></td>
					...
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="15%"><bean:message key="str3418"/></td>
		        </tr>
		       <%
		       ...
		       %>
		        <tr style="background-color:#f9f9f9;"id="changcolor_tr<%=i%>" onmouseover="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#ffffff','DIV')" onmouseout="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#f9f9f9','DIV')">
	              ...
	              <td style="color:#000000;" align="center"><a href="viewStateIndex.jsp?form_id=<%=form_id %>&menu_id=<%=meun_idx%>&quo_id=<%=quo_id%>" target="_self"><img src=/images/menuimage/9.gif width=25 height=25 border=0 alt="查看详细信息"></a></td>
	            </tr>
	            <%}%>
			    <tr>
				   ...
				   <td  align="right" colspan="3"><a href="indexMgr.jsp?iStart=1&menu_id=<%=meun_idx%>"><bean:message key="str1030"/>  </a>&nbsp; &nbsp;<a href="indexMgr.jsp?iStart=<%=pageUp%>&menu_id=<%=meun_idx%>"><bean:message key="str1031"/></a> &nbsp;<a href="indexMgr.jsp?iStart=<%=pageDown%>&menu_id=<%=meun_idx%>"><bean:message key="str1032"/>  </a>&nbsp; <a  href="indexMgr.jsp?iStart=<%=pages%>&menu_id=<%=meun_idx%>"><bean:message key="str1033"/></a></td>
		       </tr>
		       <%}%>
		    </table>
	     </td>
