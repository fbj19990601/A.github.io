	    ...
	    <td>
		     ...
		     <table width=100% border=0 cellpadding=2 cellspacing=1 align=center  bgcolor="#e7e7e7">
		        ...
		        <tr>
			        ...
			        <td class="line1" style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="20%"><bean:message key="str3439"/></td>

					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="10%"><bean:message key="str3430"/></td>

					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="15%"><bean:message key="str3431"/></td>
		        ...
		        <%
		            ...
		            {    
					     ...
					     %>
					     <tr>
							<td colspan="2"  align="left" bgcolor="#FFFFFF"style="font-weight:normal; font-size:12px; padding:2px 5px;"><bean:message key="str3988"/><%=counter%><bean:message key="str1144"/> &nbsp;<bean:message key="str3988"/><%=pages%><bean:message key="str612"/></td>
							<td colspan="3"  align="right" bgcolor="#FFFFFF" style=" font-size:12px; padding:2px 5px;"><a href="contactList.jsp?iStart=0&menu_id=<%=meun_idx%>"><bean:message key="str613"/> </a>&nbsp; &nbsp;<a href="contactList.jsp?iStart=<%=pageUp%>&menu_id=<%=meun_idx%>"><bean:message key="str614"/></a> &nbsp;<a href="contactList.jsp?iStart=<%=pageDown%>&menu_id=<%=meun_idx%>"><bean:message key="str615"/> </a>&nbsp; <a  href="contactList.jsp?iStart=<%=pages%>&menu_id=<%=meun_idx%>"><bean:message key="str616"/></a></td>
				         </tr>
					 <%}
		        %>
		        <tr>
