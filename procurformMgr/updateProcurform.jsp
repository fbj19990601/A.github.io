...
<jsp:useBean id="orderBean" class="com.saas.biz.procurformMgr.ProcurformInfo" scope="page" />
<%
    ...
    ArrayList list = orderBean.getOneProcurform(cust_id,quo_id);
				...
				<tr>
					<td valign="top">
						<table width=727 border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
							...
							<tr>
								<td style="background-color:#f6f6f6; color:#000000;  font-weight:bold; font-size:12px;" align=right>
									<bean:message key="str2334"/>
								</td>
								<td align=left bgcolor="#FFFFFF">
									<div class="ping1">
										<select name="part_delivery_tag"  id="part_delivery_tag">
										 <option value="0"><bean:message key="str1631"/></option>
										 <option value="1"><bean:message key="str1632"/></option>
										</select>
									</div>
								</td>
							</tr>
							...
							<input name="trade_type_code" type="hidden" value="1087">
