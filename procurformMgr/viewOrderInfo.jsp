...
<%
    ...
    ArrayList list = info.getOneProcurform(cust_id,quo_id);
...
<html>
	<head>
		<title><bean:message key="str2350"/></title>
						...
						<table width=727 border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
							...
							<tr>
								<td style="background-color:#f6f6f6; color:#000000;  font-weight:bold; font-size:12px;padding-top:10px;padding-bottom:10px;" align="center" colspan=2>
								   <input name="comit" type="button" value="" onclick="return confirmsub()" style="background-image: url('/images/gb.gif');width:70px;height: 26px;border:0;cursor:hand">
								</td>
							</tr>
						</table>
					</td>
