...
<%
	...
	ArrayList valueInfoList = valueInfo.getOneValue(cust_id,test_id);
	HashMap valueMap = new HashMap();
	String obj_cust_id="",test_month="",test_date="",value_name="";
	...
	if(valueInfoList!=null && valueInfoList.size()>0){
		...
		if(valueMap.get("value_name")!=null){value_name = valueMap.get("value_name").toString();}
...
<html>
	<head>
		<title><bean:message key = "str4142"/></title>
	...
	<body>
		<form name=resumeForm action=/doTradeReg.do method=post target="_self">
			<table width=100% border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
					...
					<td style="background-color:#ffffff; color:#000000;  font-size:12px;" align=left width=35%>
						<div class="ping">
							<select id="test_id" name="test_id">
								<option value="<%=test_id%>"><%=value_name%></option>
							</select>
						</div>
					</td>
				</tr>
				...
				<input name="trade_type_code" id="trade_type_code" type="hidden" value="1247">
