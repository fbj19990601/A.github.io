	    ...
	    <td>
		     <table width="560" border="0" cellpadding="2" cellspacing="1" align="center" bgcolor="#dddddd">
		        <tr>
		        	...
		        	<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="35%"><bean:message key="str751"/></td>
			        <td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="20%"><bean:message key="str3395"/></td>
              	  ...
              	  for (Iterator it = leaveList.iterator(); it.hasNext();)
                  {
							   ...
							   %>
						          ...
						          <tr style="background-color:#f9f9f9;">
						          	...
						          	<td   style=" color:#000000; padding: 2px 5px;" align=left><a href="viewFeedbackInfo.jsp?trade_id=<%=trade_id%>"><%=title%></a></td>
				         ...
				         <tr>
										...
										<a href="receiveFeedbackInfo.jsp?iStart=0"><bean:message key="str1030"/>  </a>&nbsp; &nbsp;
										<% 
											if(Integer.parseInt(iStart)>0){
										%>
											<a href="receiveFeedbackInfo.jsp?iStart=<%=pageUp%>"><bean:message key="str1031"/></a> &nbsp;
										<%
											}
											if(Integer.parseInt(iStart)<pages-1){
										%>
											<a href="receiveFeedbackInfo.jsp?iStart=<%=pageDown%>"><bean:message key="str1032"/> </a>&nbsp; 
										<%
											}
										%>
										<a  href="receiveFeedbackInfo.jsp?iStart=<%=pages-1%>"><bean:message key="str1033"/></a></td>
							    </tr>
