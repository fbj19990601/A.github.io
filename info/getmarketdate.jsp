					...
					<div id="manager_body">
						...
						<div id="manager_body_right">							 
                            <div class="newlblefttwo1">
            			       <div class="newlbone"><div class="newlbtwo2 lblj"><b><bean:message key="str2570"/></b></div></div>
            				  <div class="newlbtwo">
            				  <%
                                ...
                                if(type!=null)
                                	con = " where xtype = '"+type+"'";
                                
                                if(spage==null) spage="0";
                                else{
                                	stmp = Integer.toString(Integer.parseInt(spage)*10);
                                	}
                                String sqltext = "select * from saasnews.agriinfo "+con+" order by id desc limit "+stmp+",10";
                                //out.println(sqltext);
                                String title = "";
                             ...
                             %>
                                  <div class="newlbtwo1">
                                    <div class="newlbtwo2 lblj"><a href='showgq.jsp?id=<%= rs.getString(1) %>' target='_self'>·
                                    <%
                                    title = charset.ISO_2_GBK(rs.getString(3)) ;
                                  ...
                                  <font style="font-size:12px;color:gray">
                                        [<%=rs.getString("pubdate")%>]</font>
                                  </div>
                                  
                                  <div class="newlbtwo4">
                                  <% 
                                      content = charset.ISO_2_GBK(rs.getString(4));
                             ...
                             <%
                              ...
                              %>
                                ...
                                <%
                                    out.println(dbc.getPageList(dbc," saasnews.agriinfo ","  ","getmarketdate.jsp?p=",spage,6,20));
                                %>
                                </div>
            			   </div>
            			 </div>
