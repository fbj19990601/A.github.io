...
<%
	...
	if (id==null) id ="0";
	ResultSet rs = dbc.getRS("select * from saasnews.agriinfo where id='"+id+"'");
	String xcontact="";
    String xtel    ="";
    String xphone  ="";
    String xaddress="";
	...
	while(rs.next())
	{
		...
		xcontact = charset.ISO_2_GBK(rs.getString("xcontact")); 
        ...
        postcode = charset.ISO_2_GBK(rs.getString("postcode"));
					...
					<div id="manager_body">
						...
						<div id="manager_body_right">							 
							<div class="newxx">
                             ...
                             <div class="newxxone1"><bean:message key="str2596"/><%=xcontact%></div>
                             <div class="newxxone1"><bean:message key="str2597"/><%=xtel%></div>
                             <div class="newxxone1"><bean:message key="str2598"/><%=xphone%></div>
                             <div class="newxxone1"><bean:message key="str2599"/><%=xaddress%></div>
                             <div class="newxxone1"><bean:message key="str2600"/><%=postcode%></div>
                             <div class="newxxone1"><bean:message key="str2601"/><%=xfax%></div>
