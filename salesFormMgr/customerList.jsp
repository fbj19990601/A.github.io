...
<html>
	<head>
		<title><bean:message key="str4119"/></title>
					...
					<table width=100% border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#e7e7e7">
						...
						<tr bgcolor=#FFFFFF>
							...
							<td align="left" colspan="3">
								<a href="customerList.jsp?iStart=1"><bean:message key="str1030"/>  </a>&nbsp; &nbsp;
								<a href="customerList.jsp?iStart=<%=pageUp%>"><bean:message key="str1031"/></a> &nbsp;
								<a href="customerList.jsp?iStart=<%=pageDown%>"> <bean:message key="str1032"/> </a>&nbsp;
								<a href="customerList.jsp?iStart=<%=pages%>"><bean:message key="str1033"/></a>
							</td>
						</tr>
