...

		            {
...

		                  {
						        ...
						        <tr style="background-color:#f9f9f9; " id="changcolor_tr<%=product_id%>" onmouseover="MM_changeProp('changcolor_tr<%=product_id%>','','backgroundColor','#ffffff','DIV')" onmouseout="MM_changeProp('changcolor_tr<%=product_id%>','','backgroundColor','#f9f9f9','DIV')">
					              ...
					              <td  style=" color:#000000; padding:3px 5px;" align=left><%=product_name%></td>

					              <td  style=" color:#000000; padding:3px 5px;" align=left><%=product_desc%></td>

					              <td  style=" color:#000000; padding:3px 5px;" align=left><%=product_unit%></td>

					              <td  style=" color:#000000; padding:3px 5px;" align=left><%=product_site%></td>

					              <td  style=" color:#000000;" align=center><a href=modifyProductInfo.jsp?product_id=<%=product_id%> target=blank><img src=/img/edit.gif width=16 height=16 border=0></a></td>
					     ...
					     <tr>
							...
							<td  align="left" colspan="3"><a href="modifProductIndex.jsp?iStart=0&meun_id=<%=meun_idx%>"><bean:message key="str1030"/> </a>&nbsp; &nbsp;<a href="modifProductIndex.jsp?iStart=<%=pageUp%>&meun_id=<%=meun_idx%>"><bean:message key="str1031"/></a> &nbsp;<a href="modifProductIndex.jsp?iStart=<%=pageDown%>&meun_id=<%=meun_idx%>"><bean:message key="str1032"/> </a>&nbsp; <a  href="modifProductIndex.jsp?iStart=<%=pages%>&meun_id=<%=meun_idx%>"><bean:message key="str1033"/></a></td>
