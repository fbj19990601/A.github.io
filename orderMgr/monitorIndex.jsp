...
<html>
	<head>
		<title><bean:message key="str2816"/></title>
													...
													<table width=100% border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
														...
														%>
														 <tr>
														   ...
														   <td  align="right" colspan="3"><a href="monitorIndex.jsp?iStart=1&menu_id=<%=menu_idx%>"><bean:message key="str1030"/>  </a>&nbsp; &nbsp;<a href="monitorIndex.jsp?iStart=<%=pageUp%>&menu_id=<%=menu_idx%>"><bean:message key="str1031"/></a> &nbsp;<a href="monitorIndex.jsp?iStart=<%=pageDown%>&menu_id=<%=menu_idx%>"> <bean:message key="str1032"/></a>&nbsp; <a  href="monitorIndex.jsp?iStart=<%=pages%>&menu_id=<%=menu_idx%>"><bean:message key="str1033"/></a></td>
												       </tr>
													</table>
												</td>
											</tr>
