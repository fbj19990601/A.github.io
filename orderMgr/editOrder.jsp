...
<%
	...
	int index=0;
	String give_date=new SimpleDateFormat("yyyy-MM-dd").format(new Date());
%>
<html>
	<head>
				...
				<tr>
					<td valign="top">
						<table width=727 border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#FFFFFF">
							...
							<input type="hidden" name="give_date" id="give_date" value="<%=give_date%>">
							...
							<tr height="25px">
								<td style="background-color:#f6f6f6; color:#000000;text-align:left;" width=100%>
									备注：<bean:message key="str1026"/><input name="remark2" id="remark2" size="52" maxlength="50" value="">
								</td>
							</tr>
							<tr>
