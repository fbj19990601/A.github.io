...
<html>
	<head>
		<title><bean:message key="str2804"/></title>
													...
													<table width=100% border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
														...
														<tr>
															...
															<td align="right" colspan="3">
																<a href="auditIndex.jsp?iStart=0"><bean:message key="str1030"/>  </a>&nbsp; &nbsp;
																<%
																if (Integer.parseInt(iStart) > 0) {
																%>
																<a href="auditIndex.jsp?iStart=<%=pageUp%>"><bean:message key="str1031"/></a> &nbsp;
																<%
																	}
																	if (Integer.parseInt(iStart) < pages - 1) {
																%>
																<a href="auditIndex.jsp?iStart=<%=pageDown%>"><bean:message key="str1032"/>  </a>&nbsp;
																<%
																}
																%>
																<a href="auditIndex.jsp?iStart=<%=pages - 1%>"><bean:message key="str1033"/></a>
															</td>
														</tr>
													</table>
												</td>
