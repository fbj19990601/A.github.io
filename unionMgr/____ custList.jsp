	    ...
	    <td height="13" align="left">
	     ...
	     <div style="margin-left: 12px;margin-top: 5px;margin-bottom: 5px">
	         ...
	         <select name="relation_type_code" id="relation_type_code"  class="login_textarea" onclick="checkRaleType(this.value)">
	             <option value="0"><bean:message key="str1155"/></option>
				<%
	  ...
	  <tr>
	    <td>
		     <table width=100% border=0 cellpadding=5 cellspacing=1 align=center  bgcolor="#e7e7e7">
		        <tr>
			        <td style="background-color:#F9EEC6; color:#000000;  font-weight:bold; font-size:13px;" align=center width="11%" rowspan="2"><bean:message key="str4120"/></td>
			        <td style="background-color:#F9EEC6; color:#000000;  font-weight:bold; font-size:13px;text-align:left" align=center width="80%">
			            <input type="text" name=link value="<script src='http://soft.xsaas.com/union.jsp?id=<%=mycode%>&style=a' language='JavaScript' charset='gb2312'></script>" size="80"><br><font style="font-size:12px"><bean:message key="str4107"/></font>
	  ...
	  <tr style="display:none">
	    <td>
		     ...
		     <table width=100% border=0 cellpadding=2 cellspacing=1 align=center  bgcolor="#e7e7e7" >
		        <tr>
			        <td class="line1" style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="21%"><bean:message key="str4121"/></td>
			        <td  style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="16%"><bean:message key="str4123"/></td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="48%"><bean:message key="str4120"/></td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="15%"><bean:message key="str118"/></td>
		        ...
		        <%
		            ...
		            {    int i=0;
					     ...
					     <tr>
							<td  align="left" colspan="2"><bean:message key="str610"/><%=counter%><bean:message key="str611"/> &nbsp;<bean:message key="str610"/><%=pages%><bean:message key="str612"/></td>
							<td  align="left" colspan="3"><a href="myCustList.jsp?iStart=0&menu_id=<%=meun_idx%>&code=0"><bean:message key="str613"/> </a>&nbsp; &nbsp;<a href="myCustList.jsp?iStart=<%=pageUp%>&menu_id=<%=meun_idx%>&code=0"><bean:message key="str614"/></a> &nbsp;<a href="myCustList.jsp?iStart=<%=pageDown%>&menu_id=<%=meun_idx%>&code=0"><bean:message key="str615"/> </a>&nbsp; <a  href="myCustList.jsp?iStart=<%=pages%>&menu_id=<%=meun_idx%>&code=0"><bean:message key="str616"/></a></td>
				         </tr>
