...
<%
	...
	ArrayList reposeTypeList=paramCom.getCompareInfo("CRM","repository_type");
%>
<html>
<head>
...
<script language="JavaScript">
	...
	{
	    if (cTrim(document.reposForm.title.value,0) == "" || document.reposForm.title.value == null) 
		{                                                                                         
			alert("标题不可以为空！");                                                             
        ...
        <form name=reposForm action=/doTradeReg.do method=post>
         ...
         <%
          ...
          <tr>
            ...
            <td align=left bgcolor="#FFFFFF"><div class="ping1"><input name="title" type="text" size=70 maxlength=70 value="<%=title%>"></div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td  style="background-color:#f6f6f6; color:#000000;  font-weight:bold; font-size:13px; padding-top:10px;padding-bottom:10px;" align="center" colspan=2><input class="xgan" name="submit1" type="button" disabled="true" onclick="confirmsub(reposForm)">
            </td>
          </tr>
        </form>
      </table></td>
