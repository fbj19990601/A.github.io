...
<HTML><HEAD><title>B2B EC-platform</title>
...
height=20></TD>
        ...
        <TR>
          ...
          <TD align=middle bgColor=#eeeeee colSpan=5 height=50>
            <P><strong>I am sorry not find the page you want to visit!<br>
              <br>
            </strong></P></TD>
        ...
        <TR>
          <TD align=left colSpan=5 height=80>
            ...
            <UL>
             <LI id=list1>Did not find the page you want to visit, please check whether you enter the correct URL。  </LI><br>
             Please try the following:            
             <LI id=list1>If you are already in the address bar enter the page address, make sure that the correct spelling.</LI>
             
             <LI id=list1>Click the link back to try other links.</LI>
              
            
             </UL>
            <DIV align=right><BR>
            If you have any questions? please contact our customer service</DIV></TD></TR>
        <TR>
