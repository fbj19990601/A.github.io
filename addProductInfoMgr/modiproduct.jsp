...
<html>
	...
	{
		  if(confirm("To determine the amendments to the product information?"))
		  {
		  	return true;
		  }
		  else
	...
	<body>
		<form name=productForm method=post action=/doTradeReg.do target="_self">
			<table width="100%" border="0" cellspacing="1" cellpadding="5" style="margin-top: 13px; margin-bottom: 13px;" bgcolor="#dddddd">
				<tr>
