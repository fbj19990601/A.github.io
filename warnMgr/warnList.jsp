												...
												<tr>
													<td valign="top">
														<table width=100% border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#dddddd">
															<tr id="tr">
																<td  align="center" width="25%"><bean:message key="str4210"/></td>
																<td  align="center" width="15%"><bean:message key="str4211"/></td>
																<td  align="center" width="15%"><bean:message key="str4212"/></td>
																<td  align="center" width="10%"><bean:message key="str4213"/></td>
																<td  align="center" width="15%"><bean:message key="str4214"/></td>
																<td  align="center" width="10%"><bean:message key="str4215"/></td>
															</tr>
															<%
															...
															%>
																<td  align="left" width="25%"><a href="viewWarnType.jsp?mod_id=<%=mod_id%>" 
																TARGET=appwin onclick="mydefss()"><%=mod_name%></a></td>
																...
																<td  align="center" width="15%"><a href="addWarn.jsp?mod_id=<%=mod_id%>&mod_type=<%=w_type%>" TARGET=appwin onclick="mydefss()"><img src=/img/edit.png width=16 height=16 border=0 alt="新增预警参数"></a></td>
																</tr>
															<%}
															}%>
															<tr>
																		...
																		<a href="warnList.jsp?iStart=0">
																		<bean:message key="str1147"/> </a>&nbsp; &nbsp;
																		<% 
																			if(Integer.parseInt(iStart)>0){
																		%>
																			<a href="warnList.jsp?iStart=<%=pageUp%>">
																			<bean:message key="str1148"/></a> &nbsp;
																		<%
																			}
																			if(Integer.parseInt(iStart)<pages-1){
																		%>
																			<a href="warnList.jsp?iStart=<%=pageDown%>">
																			<bean:message key="str1149"/> </a>&nbsp; 
																		<%
																			}
																		%>
																		<a  href="warnList.jsp?iStart=<%=pages-1%>">
