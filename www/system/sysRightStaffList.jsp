...
<%
    ...
    String lawyerId =  session.getAttribute("staffId").toString();
	...
	for (int i=intBegin;i<userinfo.length;i++)
    {
    	...
    	String staffId = userinfo[i].getStaff_id().toString().trim();
...
%>
	...
	<td class="grayBL" align="left">
	    <html:link href="sysStaffRightList.jsp" name="staffmap">
	    <%=staffName%>
	    </html:link></td>
