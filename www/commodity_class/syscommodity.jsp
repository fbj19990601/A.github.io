...
<table width="100%" border="0" cellpadding="10" cellspacing="1" align="center" bordercolor="#D1D1D1" >
  ...
  <tr>    
    ...
    <a href="addcommodityclass.jsp?class=<%=commodityclass%>&classId=<%=upClassId%>&class_type=<%=class_type%>">新增分类</a>   
    </td>
  </tr>
  <tr>    
	...
	<tr> 
	    <td colspan=7> 
		    ...
		    <tr> 
				...
				<html:link href="syscommodity.jsp" name="indexmap">首页</html:link>
			    <%
				...
				<html:link href="syscommodity.jsp" name="upmap">上一页</html:link>
			    <%
				...
				<html:link href="syscommodity.jsp" name="downmap">下一页</html:link>
			    <%
			  	...
			  	%>			  		  					
				<html:link href="syscommodity.jsp" name="endmap">末页</html:link>
			    </div>
			    </td>
		    </tr>
		    </table>
