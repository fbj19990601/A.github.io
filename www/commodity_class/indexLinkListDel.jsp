...
<body>  
<h5><bean:message key="str1356"/></h5><br>
<table width="100%" border="0" cellpadding="10" cellspacing="1" align="center" bordercolor="#D1D1D1" >
    
  <tr>    
    <td class="grayD" align="center" width="8%"><bean:message key="str1357"/></td>
    <td class="grayD" align="center" width="30%"><bean:message key="str1358"/></td>
