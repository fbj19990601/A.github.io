	...
	<body>
		...
		String staff_id,start_date,end_date,rightsStr,menu_id,sql;
			...
			try {
				...
				String url = "jdbc:oracle:thin:@192.168.10.201:1521:saas";
				String user = "dev";
                ...
                StringTokenizer tk=new StringTokenizer(rightsStr,";");
		         while(tk.hasMoreTokens()){
				   ...
				   out.print(sql+"<br>");
				   stmt.execute(" delete from rightinfo where MENU_ID='"+menu_id+"' and STAFF_ID='"+staff_id+"'");
		...
		<table>
		<tr>
		<td><a href="addRights.jsp"><bean:message key="str2958"/></a></td>
		<td></td>
