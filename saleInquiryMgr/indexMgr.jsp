...
<%
	...
	ArrayList linkArray = enqBean.getEnquriyInfoByUser(Integer.parseInt(iStart), user_id,"1");
	int counter = enqBean.getEnquriyInfoByUser(user_id,"1");
					...
					<table width="100%" border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#e7e7e7">
						...
						<tr style="background-color:#f9f9f9; ">
							...
							<td style=" color:#000000;float: right;" align="right">
								<span style="color: red"><bean:message key="str412"/></span><input type="checkbox" name="chek" id="check<%=i%>" onclick="setDelete('check<%=i%>','del<%=i%>','drop<%=i%>')">
