...
<%
	...
	ArrayList linkArray = enqBean.getEnquriyInfoByTag(Integer.parseInt(iStart), user_id, "1", "0");
	int counter = enqBean.getEnquriyInfoByTag(user_id, "1", "0");
				...
				<td>
					<table width="100%" border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#e7e7e7">
						<tr class="line1">
							...
							<td align="center" width="15%">
								<bean:message key="str411"/>
							</td>
							<td align="center" width="15%">
								<bean:message key="str413"/>
							</td>
						</tr>
						<%
						...
						<tr style="background-color:#f9f9f9; ">
							<td style=" color:#000000;" align="left">
								<a href="replyEnquriy.jsp?trade_id=<%=trade_id%>" TARGET=appwin onclick="mydefss()"><%=title%> </a>
							</td>
							...
							<td style=" color:#000000;" align=center>
								<a href="replyEnquriy.jsp?trade_id=<%=trade_id%>" TARGET=appwin onclick="mydefss()"><img src=/img/edit.gif width=16 height=16 border=0 alt="Reply"> </a>
							</td>
						</tr>
						<%
						}
